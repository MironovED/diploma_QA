...
public class AuthorizationSteps {
    ...
    public static void checkInvalidData(ActivityTestRule<AppActivity> activityTestRule) {
        onView(withText(R.string.wrong_login_or_password)).inRoot(withDecorView(not(activityTestRule.getActivity().getWindow().getDecorView()))).check(matches(isDisplayed()));
    }
    ...
    public static void checkEmptyField(ActivityTestRule<AppActivity> activityTestRule) {
        onView(withText(R.string.empty_login_or_password)).inRoot(withDecorView(not(activityTestRule.getActivity().getWindow().getDecorView()))).check(matches(isDisplayed()));
    }
